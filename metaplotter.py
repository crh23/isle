...
def plotting(
    ...
    if additionalriskmodelsetting3 is not None:
        ax0.plot(
            range(len(timeseries_dict[plottype1][plot_1_3])),
            timeseries_dict[plottype1][plot_1_3],
            color=color3,
            label=label3,
        )
    if additionalriskmodelsetting4 is not None:
        ax0.plot(
            range(len(timeseries_dict[plottype1][plot_1_4])),
            timeseries_dict[plottype1][plot_1_4],
            color=color4,
            label=label4,
        )
    ax0.plot(
        range(len(timeseries_dict[plottype1][plot_1_1])),
        timeseries_dict[plottype1][plot_1_1],
        color=color1,
        label=label1,
    )
    ax0.plot(
        range(len(timeseries_dict[plottype1][plot_1_2])),
        timeseries_dict[plottype1][plot_1_2],
        color=color2,
        label=label2,
    )
    ax0.fill_between(
        range(len(timeseries_dict["quantile25"][plot_1_1])),
        timeseries_dict["quantile25"][plot_1_1],
        timeseries_dict["quantile75"][plot_1_1],
        facecolor=color1,
        alpha=0.25,
    )
    ax0.fill_between(
        range(len(timeseries_dict["quantile25"][plot_1_1])),
        timeseries_dict["quantile25"][plot_1_2],
        timeseries_dict["quantile75"][plot_1_2],
        facecolor=color2,
        alpha=0.25,
    )
    ...
    if series2 is not None:
        ...
        if additionalriskmodelsetting3 is not None:
            ax1.plot(
                range(len(timeseries_dict[plottype2][plot_2_3])),
                timeseries_dict[plottype2][plot_2_3],
                color=color3,
                label=label3,
            )
        if additionalriskmodelsetting4 is not None:
            ax1.plot(
                range(len(timeseries_dict[plottype2][plot_2_4])),
                timeseries_dict[plottype2][plot_2_4],
                color=color4,
                label=label4,
            )
        ax1.plot(
            range(len(timeseries_dict[plottype2][plot_2_1])),
            timeseries_dict[plottype2][plot_2_1],
            color=color1,
            label=label1,
        )
        ax1.plot(
            range(len(timeseries_dict[plottype2][plot_2_2])),
            timeseries_dict[plottype2][plot_2_2],
            color=color2,
            label=label2,
        )
        ax1.fill_between(
            range(len(timeseries_dict["quantile25"][plot_2_1])),
            timeseries_dict["quantile25"][plot_2_1],
            timeseries_dict["quantile75"][plot_2_1],
            facecolor=color1,
            alpha=0.25,
        )
        ax1.fill_between(
            range(len(timeseries_dict["quantile25"][plot_2_1])),
            timeseries_dict["quantile25"][plot_2_2],
            timeseries_dict["quantile75"][plot_2_2],
            facecolor=color2,
            alpha=0.25,
        )
...
plotting(
    output_label="fig_contracts_survival_1_2",
...
plotting(
    output_label="fig_reinsurers_contracts_survival_1_2",
    timeseries_dict=timeseries,
    riskmodelsetting1="one",
    riskmodelsetting2="two",
    series1="reincontracts",
    series2="reinoperational",
    plottype1="mean",
    plottype2="median",
)
plotting(
...
plotting(
    output_label="fig_contracts_survival_3_4",
    timeseries_dict=timeseries,
...
plotting(
    output_label="fig_reinsurers_contracts_survival_3_4",
    timeseries_dict=timeseries,
    riskmodelsetting1="three",
    riskmodelsetting2="four",
    series1="reincontracts",
