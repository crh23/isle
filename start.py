...
"""Create placeholder gui decorator"""
# TODO: replace this with more elegant solution if possible. Currently required since script will otherwise crash\
#  at the conditional decorator below since gui is then undefined
def gui(*args, **kwargs):
    pass


@conditionally(gui(simulation_parameters, serve=False), isleconfig.use_abce)
# TODO: Fix/remove gui and remove last of abce
def main(simulation_parameters, rc_event_schedule, rc_event_damage, np_seed, random_seed, save_iter, requested_logs=None):
    ...
    reinsurancefirms_group = simulation.build_agents(ReinsuranceFirm, 'reinsurance', parameters=simulation_parameters,
