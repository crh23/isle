...
class ReinsuranceNetwork:
    ...
    def visualize(self):
        ...
        print("Number of insurers: %i, Number of Reinsurers: %i, CatBonds: %i" % (self.num_entities["insurers"],
              self.num_entities["reinsurers"], self.num_entities["catbonds"]))
        ...
        nx.draw_networkx_nodes(
            self.network_unweighted,
            pos,
            list(range(self.num_entities["insurers"],self.num_entities["insurers"] + self.num_entities["reinsurers"])),
            node_color="r",
            node_size=50,
            alpha=0.9,
            label="Reinsurer")
        nx.draw_networkx_nodes(
            self.network_unweighted,
            pos,
            list(range(self.num_entities["insurers"] + self.num_entities["reinsurers"], self.num_entities["insurers"]
                       + self.num_entities["reinsurers"] + self.num_entities["catbonds"])),
            node_color="g",
            node_size=50,
            alpha=0.9,
...
class LoadNetwork:
    ...
    def update(self, i):
        ...
        nx.draw_networkx_nodes(
            unweighted_nx_network,
            pos,
            list(range(self.number_agent_type[i]["insurers"],self.number_agent_type[i]["insurers"]
        ...
        nx.draw_networkx_nodes(
            unweighted_nx_network,
            pos,
            list(range(self.number_agent_type[i]["insurers"] + self.number_agent_type[i]["reinsurers"],
